...
Scenario(
  "should show invalid name and not submit form",
  async ({ I }) => {
    I.amOnPage("/user/signup");
    ...
    I.dontSeeInCurrentUrl("/user/dashboard");
  }
);

Scenario("should show password mismatched and not submit form", async ({ I }) => {
  I.amOnPage("/user/signup");
...
Scenario("should show invalid phone number and not submit form", async ({ I }) => {
  I.amOnPage("/user/signup");
